...
" 		(Tue Apr 26 2005 - Ruben Justo Palmero <ruben-vim .a.t. ainek.com>: Add support for '*/<number>' ranges)
...
syntax match  crontabMin     "\_^[0-9\-\/\,\.]\{}\>\|\*\(\/\d\+\)\?"  nextgroup=crontabHr   skipwhite
syntax match  crontabHr       "\<[0-9\-\/\,\.]\{}\>\|\*\(\/\d\+\)\?"  nextgroup=crontabDay  skipwhite contained
syntax match  crontabDay      "\<[0-9\-\/\,\.]\{}\>\|\*\(\/\d\+\)\?"  nextgroup=crontabMnth skipwhite contained

syntax match  crontabMnth  "\<[a-z0-9\-\/\,\.]\{}\>\|\*\(\/\d\+\)\?"  nextgroup=crontabDow  skipwhite contained
syntax keyword crontabMnth12 contained   jan feb mar apr may jun jul aug sep oct nov dec

syntax match  crontabDow   "\<[a-z0-9\-\/\,\.]\{}\>\|\*\(\/\d\+\)\?"  nextgroup=crontabCmd  skipwhite contained
